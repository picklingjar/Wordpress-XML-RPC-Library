...
function wordpress_comment_approve($xmlrpcurl, $commentid, $username, $password, $blogid = 0, $proxyipports = ""){
	global $globalerr;
	...
	$params[] = new xmlrpcval($commentid);
	$rpcstruct= new xmlrpcval(
		...
		"struct");
	$params[] = $rpcstruct;
	$msg = new xmlrpcmsg("wp.editComment",$params);
