...
function wordpress_demo_add_two_numbers($xmlrpcurl,$number1,$number2, $proxyipports = ""){
	global $globalerr;
	$client = new xmlrpc_client($xmlrpcurl);
    $client->setSSLVerifyPeer(false);
    $params[] = new xmlrpcval($number1);
    $params[] = new xmlrpcval($number2);
	$msg = new xmlrpcmsg("demo.addTwoNumbers",$params);
