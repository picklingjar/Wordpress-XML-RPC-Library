...
function wordpress_pingback($xmlrpcurl, $pagelinkedto, $ourlink, $proxyipports = "", $useragent = "wordpress/3.2"){
	global $globalerr;
	global $GLOBALS;
	$GLOBALS['xmlrpcUserAgent'] = $useragent;
	$client = new xmlrpc_client($xmlrpcurl);
    $client->setSSLVerifyPeer(false);
	$params[] = new xmlrpcval($pagelinkedto); //linked from
	$params[] = new xmlrpcval($ourlink); //linked to
	$msg = new xmlrpcmsg("pingback.ping",$params);
