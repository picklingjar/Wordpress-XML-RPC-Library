...
function wordpress_delete_page($xmlrpcurl, $pageid, $username, $password, $blogid = 0, $proxyipports = ""){
	global $globalerr;
	...
	$params[] = new xmlrpcval($pageid);	//blog ID
	$msg = new xmlrpcmsg("wp.deletePage",$params);
