...
function wordpress_delete_link($xmlrpcurl, $username, $password, $blogid = 0, $link_id, $proxyipports = ""){
	global $globalerr;
	...
	$params[] = new xmlrpcval($link_id);
	
	$msg = new xmlrpcmsg("wp.deleteLink",$params);
