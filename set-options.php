...
/*
Options you can set - time_zone, blog_title, blog_tagline, date_format, time_format
*/
function wordpress_set_options($xmlrpcurl, $username, $password, $option, $value="",$blogid = 0, $proxyipports = ""){
	global $globalerr;
        ...
        $rpcstruct= new xmlrpcval(
                array(
                        "$option" => new xmlrpcval($value, "string"),
                ),
                "struct");
        $params[] = $rpcstruct;
        $msg = new xmlrpcmsg("wp.setOptions",$params);
