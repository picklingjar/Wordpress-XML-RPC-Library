...
function wordpress_get_recent_post_titles($xmlrpcurl, $username, $password, $blogid = 0, $numberofposts = 20, $proxyipports = ""){
	global $globalerr;
	...
	$params[] = new xmlrpcval($numberofposts); //how many posts to return
	$msg = new xmlrpcmsg("mt.getRecentPostTitles",$params);
