...
function wordpress_delete_post($xmlrpcurl, $postid, $username, $password, $proxyipports = ""){
	global $globalerr;
	$client = new xmlrpc_client($xmlrpcurl);
    $client->setSSLVerifyPeer(false);
	$params[] = new xmlrpcval("unused"); //unused arg
	$params[] = new xmlrpcval($postid);
	$params[] = new xmlrpcval($username);
	$params[] = new xmlrpcval($password);
	$params[] = new xmlrpcval("unused");
	$msg = new xmlrpcmsg("blogger.deletePost",$params);
