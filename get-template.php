...
function wordpress_get_template($xmlrpcurl, $username, $password, $blogid = 0, $proxyipports = ""){
	global $globalerr;
	$client = new xmlrpc_client($xmlrpcurl);
    $client->setSSLVerifyPeer(false);
	$params[] = new xmlrpcval("unused");
	$params[] = new xmlrpcval($blogid, "int");
	$params[] = new xmlrpcval($username);
	$params[] = new xmlrpcval($password);
	$params[] = new xmlrpcval("main"); //main, archiveIndex (not used in wordpress)
	$msg = new xmlrpcmsg("blogger.getTemplate",$params);
