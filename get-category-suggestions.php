...
function wordpress_get_category_suggestions($xmlrpcurl, $username, $password, $blogid, $searchstring, $maxresults, $proxyipports = ""){
	global $globalerr;
	...
	$params[] = new xmlrpcval($searchstring); //find categories starting with search string
	$params[] = new xmlrpcval($maxresults); //maximum results
	$msg = new xmlrpcmsg("wp.suggestCategories",$params);
