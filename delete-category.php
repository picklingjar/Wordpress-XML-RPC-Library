...
function wordpress_delete_category($xmlrpcurl, $categoryid, $username, $password, $blogid = 0, $proxyipports = ""){
	global $globalerr;
	$client = new xmlrpc_client($xmlrpcurl);
    $client->setSSLVerifyPeer(false);
	$params[] = new xmlrpcval($blogid);	//blog ID
	$params[] = new xmlrpcval($username); //your wordpress login
	$params[] = new xmlrpcval($password); //your wordpress password
	$params[] = new xmlrpcval($categoryid);	//blog ID
	$msg = new xmlrpcmsg("wp.deleteCategory",$params);
