...
function wordpress_upload($xmlrpcurl, $username, $password, $blogid = 0, $filename, $filetype, $base64, $overwrite, $proxyipports = ""){
	global $globalerr;
    ...
    $rpcstruct= new xmlrpcval(
                array(
                        ...
                        "bits" => new xmlrpcval($base64, "base64"),
                        "overwrite" => new xmlrpcval($overwrite, "boolean"),
                ),
                "struct");
    $params[] = $rpcstruct;
