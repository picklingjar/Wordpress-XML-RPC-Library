...
function wordpress_new_link($xmlrpcurl, $username, $password, $blogid = 0, $link_url, $link_name, $link_description = "", $link_category = "", $link_target = "", $proxyipports = ""){
	global $globalerr;
	...
	$params[] = new xmlrpcval($link_name);
	$params[] = new xmlrpcval($link_url);
	$params[] = new xmlrpcval($link_description);
	$params[] = new xmlrpcval($link_category);
	$params[] = new xmlrpcval($link_target);
	
	$msg = new xmlrpcmsg("wp.newLink",$params);
