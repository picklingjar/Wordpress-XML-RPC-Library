...
function wordpress_get_post_id_from_custom_fields($xmlrpcurl, $username, $password, $blogid = 0, $key, $value, $proxyipports = ""){
	global $globalerr;
        ...
        $params[] = new xmlrpcval($key);
        $params[] = new xmlrpcval($value);
        $msg = new xmlrpcmsg("wp.getPostIdFromCustomFields",$params);
